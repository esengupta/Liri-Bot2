...
4. `node liri.js concert-this <artist/band name here>`
   ...
   ![concertThis](/images/concertThis.PNG)
...
5. `node liri.js spotify-this-song '<song name here>'`
   
   ![spotifyThisSong](/images/spotifyThisSong.PNG)
...
6. `node liri.js movie-this '<movie name here>'`
